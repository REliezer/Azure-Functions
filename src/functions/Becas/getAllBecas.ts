...
export async function getAllBecas(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
    try {
        ...
        let result = await pool.request().query("SELECT * FROM becas");
